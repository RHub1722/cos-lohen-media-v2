...
Гейт перед сборкой дорожки счёта: шаг сетки 1/3 с обоснован замером
столкновений долей и якорем на круглые десятки, и он не предмет торга. Вопрос
один — влезает ли числительное в 0.333 с. Ответ даёт замер, а не оценка.
