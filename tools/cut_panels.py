...
PANELS: dict[str, list[tuple]] = {
    ...
    "spear_down__45_98-47_63": [
        ...
        # Панель врезана заново, tools/graft_panel.py: наконечник теперь вверху.
        # x1 не дальше 596 — с 598 начинается пунктир угла, а его в кадре быть
        # не должно.
        ("hold",    "46.19",  350,  130,  596,  838),
