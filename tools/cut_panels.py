...
PANELS: dict[str, list[tuple]] = {
    ...
    "spear_down__45_98-47_63": [
        # y0 ниже «1. ЗАМАХ 45.98»: самый кончик древка теряется, но кадр чистый
        ("windup",  "45.98",  140,  128,  430,  905),
        ("hold",    "46.19",  535,  125,  770,  905),
        ("contact", "47.03",  925,  160, 1210,  905),
        ("hold2",   "47.63", 1385,  195, 1570,  905),
    ],
}
