...
`report.md` **генерируется** — правки в нём затрутся следующим прогоном. Разбор
руками живёт в `docs/status/`, например
[2026-08-05-training-review.md](../docs/status/2026-08-05-training-review.md).
...
| `dip_ratio` | впадина между всплесками, долей от них. Мера связки |
| `hip_lead` | бёдра опередили кисти, с. Считается внутри удара, не по клипу |
