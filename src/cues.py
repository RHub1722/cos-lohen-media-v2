...
# железа, одно на все якоря и на ОБА инструмента — и слова, и ризы, — потому и
# живёт здесь, рядом с якорями, а не в каком-то одном сборщике. Продублируй её
# в двух местах, и однажды они разойдутся.
#
