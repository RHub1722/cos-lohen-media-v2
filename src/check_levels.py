...
# Окна акцентов для проверки иерархии. Границы пришлось расширить после того, как
# удары переехали по картинке: серия 1 с 28.80 на 29.13, серия 3 с 39.20 на 39.87,
# и в серии 3 появился третий удар на 40.90. Прежнее окно кончалось на 39.9 и
# новый удар не видело — то есть он мог бы перебить финальный, а проверка бы
# промолчала.
ACCENTS = [
    ("дверь", 22.3, 23.2),
    ("раскрутка", 25.5, 26.9),
